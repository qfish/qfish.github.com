  ...
  */
  ...
  Toc.prototype.traverse = function(){
      ...
      for (var j = 0; j < found.length; j++ ){
        ...
        // id = element.getAttribute('id') || "toc-" + j || txt.replace(/[^a-z0-9]+/ig, "-");
        id = "toc-" + j || txt.replace(/[^a-z0-9]+/ig, "-");
        ...
        switch(true) {
          case (tagNumber > previous):
            html += "<ul class=\"nav\"><li><a href=\"#"+ id + "\">" + txt + "</a>";
            previous = tagNumber;
            break;
      ...
      while(tagNumber >= 0 && tagNumber != this.options.start) {
        html += "</ul>";
        tagNumber--;
      }
